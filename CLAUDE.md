...
- **PENDIENTE DE VERIFICAR EN VIVO:** que `generateLink` efectivamente NO dispare el mail automático de Supabase además del de Resend — el comportamiento documentado de Supabase dice que no. Si llega un mail duplicado, hay que desactivar el template de invitación desde el Supabase Dashboard.
